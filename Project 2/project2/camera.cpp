...
void Camera::lookAt(Vec3f eye, Vec3f at, Vec3f up) {
	...
	GLfloat* pointertoTransMatrix = new GLfloat[16];
	Mat4<GLfloat> transMatrix = RM * TM;
	transMatrix.getGLMatrix(pointertoTransMatrix);
	glMultMatrixf(pointertoTransMatrix);
}	
